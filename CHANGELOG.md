...
## [v1.1.0](https://github.com/brgmnn/gtfo-killable-spitters/releases/tag/v1.1.0) — July 28, 2026

### New

* [ExtraWeaponCustomization](https://thunderstore.io/c/gtfo/p/Dinorush/ExtraWeaponCustomization/) (EWC) compatibility — custom weapons can now hurt spitters (verified against EWC 4.12.0 and 4.12.6; soft dependency, no effect without EWC installed)
